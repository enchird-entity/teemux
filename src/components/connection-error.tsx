...
export const ConnectionError: React.FC<ConnectionErrorProps> = ({
  ...
  return (
    <div className="flex flex-col items-center justify-center h-full w-full bg-[#1a1a24] p-8">
      <div className="w-full max-w-md bg-[#252532] rounded-lg shadow-lg p-6">
        ...
        {logs && logs.length > 0 && (
          <div className="mb-6">
            ...
            {showLogs && (
              <div className="bg-[#121218] rounded p-2 max-h-32 overflow-y-auto text-xs font-mono text-gray-300">
                {logs.map((log, index) => (
