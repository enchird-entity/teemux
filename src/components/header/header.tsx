        ...
        <div className="relative flex-1">
          ...
          {searchValue && !checkIsValidSshConnectionString(searchValue) ? (
            ...
            <Button
              ...
              className="absolute text-[10px] right-2 top-1/2 transform -translate-y-1/2 bg-[#f97316] hover:bg-[#ea580c] text-white h-6 px-2 rounded-md"
        ...
        <div className="flex items-center gap-2">
          <DropdownMenu>
            <Button
              onClick={onNewHost}
              variant="outline"
              className="gap-2 bg-[#252532] border-[#2d2d3a] text-white hover:bg-[#2d2d3a] h-8 px-1">
              <Server size={14} />
              <span className="font-semibold text-xs border-r pr-2">
                NEW HOST
              </span>
